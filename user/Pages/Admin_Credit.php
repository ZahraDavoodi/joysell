...
<div class="row credit text-center">
    <form action="operation.php" method="post"  class="form-group">
       ...
       <div class="col-sm-4"> <input type="text"  value="<?php
           ...
           ?>" placeholder="مبلغ درخواستی به تومان" class="form-control" name="amount"></div>
        <div class="col-sm-4"> <input type="text" class="form-control" name="sheba" id="sheba" placeholder="شماره شبا"></div>
        <div class="col-sm-4"> <input typ="text" class="form-control" name="name" placeholder="به نام"></div>
