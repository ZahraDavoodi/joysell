...
echo '<span class="pnumber ">'.'تعداد محصولات شما : '.$count.'</span> <br> ';
echo '<span class="pnumber1"><a href="../index.php#plans">'.'ارتقای حساب '.'</a></span>';
?>
<div class="row">
    ffffff
</div>
...
<table class="table table-responsive table-stripped " id="table">
    ...
    $select=select("SELECT * FROM  link_orderplan where user_id='$user_id'");
